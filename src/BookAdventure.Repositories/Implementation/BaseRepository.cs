...
/// <summary>
/// Repositorio base que proporciona operaciones CRUD con soporte para eliminación lógica
/// </summary>
...
public abstract class BaseRepository<T> : IBaseRepository<T> where T : BaseEntity
{
    ...
    /// <summary>
    /// Proporciona acceso directo al IQueryable para consultas complejas
    /// </summary>
    ...
    /// <summary>
    /// Proporciona acceso directo al IQueryable incluyendo eliminadas
    /// </summary>
    public virtual IQueryable<T> QueryIncludingDeleted()
    {
        return _context.IncludeDeleted<T>().AsQueryable();
    }
}
